...
import { getQualificationTitle, slugToTitle } from '../utils/common';
import UsePagination from './UsePagination';
import moment from 'moment';
import { RecruitmentContent } from './json/RecruitmentContent';
import { RecruitmentFaqs } from './json/RecruitmentFaqs';
import { RecruitmentStats } from './json/RecruitmentStats';
import { RecruitmentBadges } from './json/RecruitmentBadges';
import { RecruitmentAbout } from './json/RecruitmentAbout';
import { ListClass } from './json/ListClass';
import { BadgeCheck, Landmark, Award, BookOpenCheck, BriefcaseBusiness, CalendarDays, CircleCheckBig, CircleHelp, ClipboardCheck, Flame, GraduationCap, IdCard, RefreshCw, Search, Users } from 'lucide-react';
...
export default function Recruitment({ slug }) {
    ...
    const categoryIcons = {
        "government-job": Landmark,
        "upsc-job": Landmark,
        "ssc-job": Landmark,
        "railway-job": Landmark,
        "bank-job": Landmark,
        "defence-job": Landmark,
        "teaching-job": Landmark,
        "contractual-job": Landmark
    };
    ...
    const content = RecruitmentContent[slug] || {};
    const faqs = RecruitmentFaqs[slug] || [];
    const stat = RecruitmentStats[slug];
    const badges = RecruitmentBadges[slug] || [];
    const aboutData = RecruitmentAbout[slug];
    ...
    return (
        <div className="container job-dtl main">
            ...
            <div className="row">
                <div className="col-sm-12">
                    ...
                    <div className="hero-box card-box mt-3">
                        ...
                        <div className="trust-badges edu">
            ...
            <div className="breadcrumb-box mb-3">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mb-0">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">{title}s</li>
                    </ol>
                </nav>
            </div>
            ...
            <section className="related-posts">
                ...
                <h2><Flame size={32} /> Trending {title}s</h2>
