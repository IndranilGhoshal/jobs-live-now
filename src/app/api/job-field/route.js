...
export async function GET(request) {
    ...
    try {
        ...
        const fields = [
            ...
            { fieldName: "Tags", fieldType: "multiselect", value: [], isMandotary: true, icon: "🏷️", placeholder: "", selectvalue: [{ name: "10th" }, { name: "ITI" }, { name: "Diploma" }, { name: "12th" }, { name: "Graduation" }, { name: "Post-Graduation" }, { name: "Mphil" }, { name: "Phd" }] },
