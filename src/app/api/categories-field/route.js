...
export async function GET(request) {
    ...
    try {
        ...
        const fields = [
            ...
            { fieldName: "Job Category", fieldType: "singleselect", value: "", isMandotary: true, icon: "🏢", placeholder: "", selectvalue: [{ name: "Admit Card" }, { name: "Results" }, { name: "Answer Key" }, { name: "Syllabus" }, { name: "Admission Form" }] },
            { fieldName: "Job Advertisement Number", fieldType: "text", value: "", isMandotary: false, icon: "💼", placeholder: "Job Title", selectvalue: [] },
            { fieldName: "Job Type", fieldType: "singleselect", value: [], isMandotary: true, icon: "💼", placeholder: "", selectvalue: [{ name: "Bank Job" }, { name: "Railway Job" }, { name: "Defance Job" }, { name: "Teaching Job" }, { name: "Contactual Job" }, {name:"All India Govt. Job"}, {name:"State Govt. Job"}, {name:"PSU Job"}, {name:"Private Job"}] },
            { fieldName: "Qualification Allow", fieldType: "multiselect", value: [], isMandotary: true, icon: "💼", placeholder: "", selectvalue: [{ name: "10th Pass" }, { name: "ITI Pass" }, { name: "Diploma Pass" }, { name: "12th Pass" }, { name: "Graduation Pass" }, { name: "Post-Graduation Pass" }, { name: "Mphil Pass" }, { name: "Phd Pass" }] },
            { fieldName: "Tags", fieldType: "multiselect", value: [], isMandotary: true, icon: "🏷️", placeholder: "", selectvalue: [{ name: "8th" }, { name: "10th" }, { name: "ITI" }, { name: "Diploma" }, { name: "12th" }, { name: "Graduation" }, { name: "Post-Graduation" }, { name: "Mphil" }, { name: "Phd" }] },
