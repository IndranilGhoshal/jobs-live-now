...
export async function GET(request) {
    ...
    try {
        ...
        const fields = [
            ...
            { fieldName: "Job Type", fieldType: "singleselect", value: [], isMandotary: true, icon: "💼", placeholder: "", selectvalue: [{name:"Government Job"}, { name: "UPSC Job" }, { name: "SSC Job" }, { name: "Bank Job" }, { name: "Railway Job" }, { name: "Defence Job" }, { name: "Teaching Job" }, { name: "Contactual Job" }] },
